...
const menuItems: Record<string, { label: string; icon: any; path: string }[]> = {
  [Role.SUPER_ADMIN]: [
    ...
    { label: 'Contact Persons', icon: FiUserCheck, path: '/superadmin/clients' },
  ...
  [Role.ADMIN]: [
    ...
    { label: 'Contact Persons', icon: FiUserCheck, path: '/admin/clients' },
  ...
  [Role.EMPLOYEE]: [
    ...
    { label: 'Contact Persons', icon: FiUserCheck, path: '/employee/clients' },
  ...
  [Role.LAB]: [
    ...
    { label: 'Contact Persons', icon: FiUserCheck, path: '/lab/clients' },
    ...
    { label: 'Invoices', icon: FiDollarSign, path: '/lab/invoices' },
    { label: 'Quotations', icon: FiFile, path: '/lab/quotations' },
    { label: 'Templates', icon: FiLayout, path: '/lab/templates' },
  ],
  [Role.LAB_EMP]: [
    { label: 'Dashboard', icon: FiHome, path: '/labemp/dashboard' },
    { label: 'Contact Persons', icon: FiUserCheck, path: '/labemp/clients' },
    { label: 'Test Orders', icon: FiFileText, path: '/labemp/orders' },
    { label: 'Lab Reports', icon: FiActivity, path: '/labemp/reports' },
    { label: 'Invoices', icon: FiDollarSign, path: '/labemp/invoices' },
    { label: 'Quotations', icon: FiFile, path: '/labemp/quotations' },
  ],
  [Role.CLIENT]: [
